...
<li><a href="#dinvoicesms_tofran" onclick="load_smslog_data(this,'end_dysms',0)" >Delivered Invoice SMS </a></li>
<li><a href="#rinvoicesms_tofran" onclick="load_smslog_data(this,'end_dysms',0)" >Returned Invoice SMS </a></li>
