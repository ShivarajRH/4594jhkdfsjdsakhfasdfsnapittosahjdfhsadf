<div class="container">
    <div id="orders_status_summary_div">&nbsp;</div>
<?php
/*
<?php $prefix=array();
...
<h2>Order status summary between <?=$s?> and <?=$e?></h2>
...
<thead>
	<tr>
            ...
            <th>Deal</th>
            <th>Product(s)</th>
            <th>Stocks</th><th>Amount</th><th>Time</th>
        </tr>
</thead>
<tbody>
 ...
 //$(document).ready(function() {
        //FIRST RUN
           ...
           function loadTableData() {
                var ajax_url=$("table").data("sdata").url;//$('#franchise_ord_list_frm').attr('action')
                $('.orders_status_summary_div').html("Loading...");

                $.post(ajax_url,$('#orders_status_summary_div').serialize()+'&stat='+stat,function(resp){
