				...
				<?php foreach($pnh_pending_shipments_list as $i=>$shipment){?>
					<tr class="row_<?php echo $shipment['invoice_no'];?>">
						...
						<td class="unselectable">
							<span class="<?php echo 'show_inv_'.$shipment['invoice_no'];?>" style="display:none;"><?php echo $shipment['invoice_no'];?></span>
							<input type="checkbox" name="invoices[]"  class="<?php echo 'scan_'.$shipment['invoice_no'];?>" value="<?php echo $shipment['invoice_no'];?>" style="display:none;">
						</td>
						<td><b>Pending</b></td>
					</tr>
				<?php }?>
