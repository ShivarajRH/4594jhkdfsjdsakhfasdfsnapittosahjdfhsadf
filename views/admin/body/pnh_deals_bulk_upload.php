...
<?php $template=array("Deal Name","Tagline","Category (ID)","Brand (ID)","MRP","Offer Price","Store Price","NYP Price","Gender Attribute","Image ID","Tax","Description","Products","Products Group","keywords","Menu (ID)","Ships In","Publish"); ?>
<thead>
<tr>
