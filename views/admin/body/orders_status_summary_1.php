...
<script>
    ...
    $("#sel_franchise").live("change",function() {
        var franchiseid=$(this).find(":selected").val();//text();
        if(franchiseid=='00') {
            $(".sel_status").html("Please select franchise."); return false;
        }
        ...
        if(!terrid) {
         ...
         $("table").data("sdata", {terrid:terrid,townid:townid,franchiseid:franchiseid});
    ...
    $(".load_type").bind("click",function(e){
        ...
        var franchiseid=$("table").data("sdata").franchiseid;
        ...
        $("table").data("sdata", { terrid:terrid,townid:townid,franchiseid:franchiseid,type:stat,date_from:date_from,date_to:date_to, issorting : "no",idname:'',classname:'',firstrun:'no',pagination:"false",url:url });
    ...
    $("#ord_list_frm").bind("submit",function(e){
        ...
        $("table").data("sdata", {terrid:terrid,townid:townid,franchiseid:franchiseid,type:'all',date_from:date_from,date_to:date_to,  issorting : "no",idname:'',classname:'',firstrun:'no',pagination:"false",url:url });
        load_all_orders(stat);
        return false;
    });
    ...
    $("#orders_status_pagination a").live("click",function(e){
            ...
            var townid=$("table").data("sdata").townid;
            var franchiseid=$("table").data("sdata").franchiseid;
            $("table").data("sdata", { terrid:terrid,townid:townid,franchiseid:franchiseid, issorting : "no",idname:'',classname:'',firstrun:'no',pagination:"true",url:ajax_url });
    ...
    function load_all_orders(stat) {
		...
		$('.tab_list #'+type).addClass('selected');
                ...
                var date_from=$( "#date_from").val();
                var date_to=$( "#date_to").val();
                $("table").data("sdata", { terrid :'',townid:'', franchiseid:'', type:'all',date_from:date_from,date_to:date_to, issorting : "no",idname:'',classname:'',firstrun:'true',pagination:"false",url:url });
    ...
    function terrtownfranchise() {
        var url="<?php echo site_url("admin/jx_orders_status_summary"); ?>";
        var terrid=$("table").data("sdata").terrid;
        var townid=$("table").data("sdata").townid;
        var franchiseid=$("table").data("sdata").franchiseid;
        
        var type=$("table").data("sdata").type;
        var date_from=$("table").data("sdata").date_from;
        var date_to=$("table").data("sdata").date_to;
        
        var indata="/"+type+"/"+date_from+"/"+date_to+"/"+terrid+"/"+townid+"/"+franchiseid; 
