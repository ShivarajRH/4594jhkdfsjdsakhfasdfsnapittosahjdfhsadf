...
<?php if(!$v){?>
<li><a href="#v_security">Security Deposit</a></li>
<?php }?>
</ul>

<div id="v_details">
<table width="100%">
<tr><td>Name</b></td><td>:</td><td><input type="text" name="name" class="inp mand" size="40" value="<?=$v?"{$v['franchise_name']}":""?>"></td></tr>
<tr><td>Address</td><td>:</td><td><input type="text" name="address" class="inp mand" size="50" value="<?=$v?"{$v['address']}":""?>"></td></tr>
<tr><td>Locality</td><td>:</td><td><input type="text" name="locality" size="30" class="inp mand" value="<?=$v?"{$v['locality']}":""?>"></td></tr>
<tr><td>City</td><td>:</td><td><input type="text" name="city" class="inp mand" value="<?=$v?"{$v['city']}":""?>"></td></tr>
<tr><td>State</td><td>:</td><td><input type="text" name="state" class="inp mand" value="<?=$v?"{$v['state']}":""?>"></td></tr>
<tr><td>Postcode</td><td>:</td><td><input type="text" name="postcode" class="inp mand" value="<?=$v?"{$v['postcode']}":""?>"></td></tr>
</table>
</div>

<div id="v_login">
<table width="100%">
<tr><td>Login Mobile 1</td><td>:</td><td><input type="text" maxlength="10" class="inp mand loginmob1" name="login_mobile1" value="<?=$v?"{$v['login_mobile1']}":""?>"><span id="mob1_error"></span></td></tr>
...
<?php for($i=1;$i<=24;$i++){?>
<option value="<?=$i?>" <?=(($v&&date("h",$v['store_open_time'])==$i)?'selected':"")?>><?=date("g:ia",mktime($i,0))?></option>
<?php }?>
</select>
to 
<select name="shop_to">
<?php for($i=1;$i<=24;$i++){?>
<option value="<?=$i?>" <?=(($v&&date("h",$v['store_close_time'])==$i)?'selected':"")?>><?=date("g:ia",mktime($i,0))?></option>
<?php }?>
</select>
</td></tr>
<tr><td>Own Property? :</td><td><input type="checkbox" name="own" value="<?=$v&&$v['own_rented']==1?"1":"0"?>"></td></tr>
...
<tr>
<td>security question</td><td>:</td><td><select name="sec_q" class="sec_q">
...
<table cellpadding=5>
<tr><td>Amount </td><td>:</td><td>Rs <input type="text" class="inp amount" name="sec_amount" size=5></td></tr>
<tr><td>Instrument Type </td><td>:</td><td><select name="sec_type" class="inst_type">
<option value="0">Cash</option>
<!--  <option value="1">Cheque</option>-->
<option value="2">DD</option>
<option value="3">Transfer</option>
</select></td></tr>
<tr class="inst inst_name"><td class="label">Bank name </td><td>:</td><td><input type="text" name="sec_bank" size=30></td></tr>
<tr class="inst inst_no"><td class="label">Instrument No</td><td>:</td><td><input type="text" name="sec_no" size=10></td></tr>
<tr class="inst inst_date"><td class="label">Instrument Date</td><td>:</td><td><input type="text" name="sec_date" id="sec_date" size=15></td></tr>
<tr class="inst_msg"><td>Message</td><td>:</td><td><input type="Text" class="inp msg" name="sec_msg" size=50></td></tr>
</table>
</div>
<?php }?>
...
$(function(){
	...
	$("#pnh_af_form").submit(function(){
		...
		{
			alert("Check login mobile numbers");
			return false;
		}
		$("input.mand",$(this)).each(function(){
			if($(this).val().length==0)
			{
				alert($("td:first",$(this).parents("tr").get(0)).text()+" is missing");
				f=false;
				return false;
			}
		});
		...
		{
			alert("Please enter valid login email");
			f=false;
		}
