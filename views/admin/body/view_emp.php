				...
				<tr>
					<td valign="top">
						...
						<tr>
							...
							<td width="50%">	
								<div class="avatar" style="float: right;margin-right:-59px;" >
								<?php 
								...
								<?php }else{ 
									echo '<div style="height: 50px;width: 50px;background: #f8f8f8;text-align: center;padding:20px;">No image updated</div>';
								}?>
								</div>
							</td>
						</tr>
