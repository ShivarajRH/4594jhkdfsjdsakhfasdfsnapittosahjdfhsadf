...
define('MIN_AMT_FREE_SHIP',400);
define('SHIPPING_CHARGES',40);
define("COD_CHARGES",40);
define("FAV_DISCOUNT",10);
define("FAV_LIMIT",5);
define("FAV_EXPIRY",90);

define("REORDER_DISCOUNT",5);
 
define("COMBINED_BUY_DISCOUNT",0);

define("MAX_HISTORY",40);

define("GIFTCARD_MENU",10);

define("GIFTWRAP_CHARGES",15);

define('PHC_PERCENT',0); 
 
define("PRODUCT_SERVICE_TAX",12.36);
...
define('REORDER_VALID_DAYS',30);

define('SUBSCRIBE_COUPON_VALUE',50);

define('SUBSCRIBE_COUPON_MIN',500);

define('SUBSCRIBE_COUPON_VALID',40);
